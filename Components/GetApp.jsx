  ...
  return (
    <div className={styles.AppContainer}>
        ...
        <div className={styles.AppBody}>
            ...
            <form className={styles.form} method="post" name="FormName" action="Sign.php">
                <div className={styles.MailOrPhone}>
                    <div className={styles.Radio}>
                        <input type="radio" name="R_app" id="email" defaultChecked={true}/>
                ...
                <div className={styles.inputBox} >
                    <input type="text" name="Pbox" id="InputBox" placeholder="Enter Email here..." onChange=''/>
