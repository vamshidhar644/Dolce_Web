...
import {Intro , Collections, Localities, GetApp, OtherOptions} from '../Components/index'

import React from "react"
import {client} from '../lib/client';

const Home = ({IntroData, HomeCardsData, LocalitiesData, CollectionsData, CollectionCardData}) => {
    ...
    <div>
      ...
      <div className="Home">
        ...
        <div className="HomeCardsContainer">
          {HomeCardsData?.map((homecards) =>  <Intro key={homecards._id} homecards={homecards}/>)}
        </div>
      </div>
      ...
      <div className="CollectionsContainer">
        ...
        <div className="CollectionsBody">
            {CollectionCardData?.map((collectionscards) => <Collections key={collectionscards._id} collectionscards={collectionscards}/>)}
        </div>
      </div>
      
      <h1 className="LocailtyHeader">Popular Localities in and around Hyderabad</h1>
...
export const getServerSideProps = async () => {
  ...
  return {
    props: {IntroData, HomeCardsData, LocalitiesData, CollectionsData, CollectionCardData}
  }
}
